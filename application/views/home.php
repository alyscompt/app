	...
	<div class="row">
		...
		<div class="col-md-3">
			...
			<div class="box">
				...
				<?php $antri = $this->M_crud->get_max_id('transaksi', 'no_antrian', array('id_loket' => $row->id_loket, 'tgl' => date('dmY')))->row();
					?>
				<?php echo ucwords(strtoupper($row->str_loket)) ?> - <?php echo $antri->no_antrian ;?>
