...
<audio id="suarabelnomorurut" src="<?php echo base_url('audio/antrian/antrian.wav'); ?>"></audio> 
<audio id="diloket" src="<?php echo base_url('audio/antrian/loket.MP3'); ?>"></audio>


<?php if(isset($antrian_rw->str_antrian)) {
	$antrt_rw = $antrian_rw->str_antrian;
} else {
	$antrt_rw = '-';
 } ?>
...
if($antrian > 11 && $antrian < 20){ ?>
	<audio id="antrianstr" src="<?php echo base_url('audio/antrian/'.$antrt_rw.'.wav'); ?>"></audio>
...
<?php
	...
	$b = substr($antrian, -1,1);
		echo "<audio id='antrianstr' src='".base_url('audio/antrian/'.$antrt_rw).".wav'></audio>";
...
<audio id="puluh" src="<?php echo base_url('audio/antrian/puluh_ok.wav'); ?>"></audio>
<audio id="ratus" src="<?php echo base_url('audio/antrian/ratus.MP3'); ?>"></audio>
	...
	<div class="row">
		<div class="col-md-3">
			...
			foreach ($lok as $l) { ?>
				<div class="box">
					...
					<div>
						<h1 style="color:#000">
						<?php echo ucwords(strtoupper($l->str_loket)) ?> - 
						<?php echo $this->M_crud->get_max_id('transaksi', 'no_antrian', array('id_loket' => $l->id_loket, 'tgl' => date('dmY'), 'id_loket !=' => $loket->id_loket ))->row('no_antrian') ?></h1>
					</div>
				</div>
			<?php
		}
		...
		<div class="col-md-6">
			...
			<div class="box">
				...
				<div class="agenda">
					<h1 id="a"><?php echo ucwords(strtoupper($loket->str_loket)) ?> - <?php echo $antrian; ?></h1>
						<center>
	...
	<script type="text/javascript">
		function panggil(){
			...
			//playnomerurutnya
			setTimeout(function(){
				document.getElementById("antrianstr").pause();
				document.getElementById("antrianstr").currentTime=0;
				document.getElementById("antrianstr").play();
			}, totalWaktu);
