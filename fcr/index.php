...
<body>
    ...
    <div id="parent1">
      ...
      <div id="parent2" style="float:left;">
        <br><br>
       <center> <button id="register" class="button button1" style="background-color:green; font-size:20px;"> PILIH LOKET </button>  </center>
      <!--  <button id="login" class="button button1" style="margin-left: 30px;"> Log In</button>-->
        ...
        <img id = "prof_img" style="display: none; margin-left: 210px; height:200px; width: 200px; border: 3px solid black; border-radius: 10px;" ></img><br><br>
        
        <div id="reg_disp" style="display: none;">
		
         
		<button id="capture" class="button button1" style="margin-left: 120px;height:80px; background-color:green; color:#ffffff; width:100%; font-size:20px;"> LOKET PENDAFTARAN</button><br><br><br><br>
        <button id="capture1" class="button button1" style="margin-left: 120px;height:80px; background-color:blue; color:#ffffff;  width:100%; font-size:20px;"> LOKET INFORMASI </button><br><br><br><br>
		<button id="capture2" class="button button1" style="margin-left: 120px;height:80px; background-color:red; color:#ffffff;  width:100%; font-size:20px;"> LOKET PENGAMBILAN </button><br><br><br><br>
